...
def test_memory_lifecycle(page, target_url):
    ...
    page.locator(StreamlitLocators.SIDEBAR).click()
    
    page.get_by_label("Add Knowledge").fill(unique_string)
    page.get_by_role("button", { "name": "Store Memory" }).click()
    ...
    chat_input.fill(f"What was that unique string I told you? {unique_string}")
